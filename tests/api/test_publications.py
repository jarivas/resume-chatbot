...
@pytest.mark.asyncio
async def test_publications_post_endpoint(test_client: AsyncClient):
    publications_data = {
    ...
    response = await test_client.post("/publications", json=publications_data)
...
@pytest.mark.asyncio
async def test_publications_get_by_id_endpoint(test_client: AsyncClient):
    publications_data = {
        "name": "Research Article",
        "publisher": "Nature",
    }

    create_response = await test_client.post("/publications", json=publications_data)
...
@pytest.mark.asyncio
async def test_publications_get_all_endpoint(test_client: AsyncClient):
    publications_data1 = {"name": "Pub 1", "publisher": "Pub 1"}
    publications_data2 = {"name": "Pub 2", "publisher": "Pub 2"}

    await test_client.post("/publications", json=publications_data1)
    await test_client.post("/publications", json=publications_data2)
...
@pytest.mark.asyncio
async def test_publications_patch_endpoint(test_client: AsyncClient):
    publications_data = {
...
@pytest.mark.asyncio
async def test_publications_delete_endpoint(test_client: AsyncClient):
    publications_data = {
...
@pytest.mark.asyncio
async def test_publications_get_not_found_endpoint(test_client: AsyncClient):
    response = await test_client.get("/publications/nonexistent-id")
    assert response.status_code == 404


@pytest.mark.asyncio
async def test_publications_patch_not_found_endpoint(test_client: AsyncClient):
    update_data = {"summary": "Test summary"}
    response = await test_client.patch("/publications/nonexistent-id", json=update_data)
    assert response.status_code == 404


@pytest.mark.asyncio
async def test_publications_delete_not_found_endpoint(test_client: AsyncClient):
